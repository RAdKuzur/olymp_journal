...
<?php $this->beginPage() ?>
    ...
    <header>
        <?php
        NavBar::begin([
            'brandLabel' => Yii::$app->params['backName'],
        ...
        $menuItems = [
            ...
            ['label' => 'Админ-панель. Заявки', 'url' => ['admin/application/index']],
        ];
        ...
        if (!Yii::$app->request->cookies->getValue('usernameBack')) {
            echo Html::tag('div',Html::a('Login',['/site/login'],['class' => ['btn btn-link login text-decoration-none']]),['class' => ['d-flex']]);
        } else {
            echo Html::beginForm(['/site/logout'], 'post', ['class' => 'd-flex'])
                . Html::submitButton(
                    'Logout (' .  Yii::$app->request->cookies->getValue('usernameBack')['email'] . ')',
